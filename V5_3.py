...
This project draws heavily from Fast Style Transfer for Arbitrary Styles (establsihed by The TensorFlow Hub Authors, Copyright 2019, Licensed under the Apache License, Version 2.0 (the "License")) and Facebook AI Research's Detectron2 (Licensed under the Apache License, Version 2.0 (the "License")). This license can be found in the LICENSE file.
